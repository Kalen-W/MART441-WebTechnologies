...
// Reads data from the queryString.
function readQueryString(queryObject) {
  // Access all queryString variables.
  if (queryObject != null) {
...
function writeTextFile(writeData) {
  fs.writeFile('fullName.txt', writeData, function(err) {
    if (err) { return console.error(err); }

    console.log("Data successfully written to 'fullName.txt'");

    fs.readFile('fullName.txt', function(err, data) {
      if (err) { return console.error(err); }
